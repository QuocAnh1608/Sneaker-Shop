...
<body>
	<div class="wrapper">
		...
		<div id="lg-bg">
			<img src="<c:url value = '/views/img/login-bg.png'/>" alt="">
		</div>
		<!--================Login Box Area =================-->
				...
				<div class="row">
					<div class="col-lg-6">
						<div class="login_box_img">
							<img class="img-fluid" src="<c:url value='/views/img/login.jpg'/>" alt="">
							<div class="hover">
								<h4>New to our website?</h4>
								<p>There are advances being made in science and technology
									everyday, and a good example of this is the</p>
								<a class="primary-btn" href="registration.jsp">Create an
									Account</a>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-6">
						<div class="login_form_inner">
							...
							<form class="row login_form" action="/Demoasm/login"
								method="post">
								...
								<div class="col-md-12 form-group">
									<div class="creat_account">
										...
										<label for="f-option2"> Keep me logged in
										</label>
									</div>
								</div>
								<div class="col-md-12 form-group">
